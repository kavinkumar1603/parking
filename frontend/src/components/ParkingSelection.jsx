    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 md:px-8 py-8">
            <div className="max-w-5xl w-full text-center">
                {/* Heading */}
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-1 sm:mb-2">
                    SMART PARKING
                </h1>
                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-blue-500 mb-4 sm:mb-6">
                    MADE SIMPLE
                </h2>
                
                {/* Description */}
                <p className="text-gray-400 text-sm sm:text-base md:text-lg mb-8 sm:mb-12 md:mb-16 px-4">
                ...
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center mb-8 sm:mb-12 px-4">
                    {/* Car Card */}
                    <div className="bg-zinc-900 rounded-3xl p-8 sm:p-10 md:p-12 w-full sm:w-80 md:w-96 cursor-pointer hover:bg-zinc-800 active:scale-95 transition-all touch-manipulation" onClick={handlecar}>
                        <div className="bg-blue-800 rounded-2xl w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                    ...
                    {/* Bike Card */}
                    <div className="bg-zinc-900 rounded-3xl p-8 sm:p-10 md:p-12 w-full sm:w-80 md:w-96 cursor-pointer hover:bg-zinc-800 active:scale-95 transition-all touch-manipulation" onClick={handlebike}>
                        <div className="bg-blue-800 rounded-2xl w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                            <svg className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400" fill="currentColor" viewBox="0 0 24 24">
